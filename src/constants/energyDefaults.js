export const ENERGY_DEFAULTS = {
  oil: {
    ...
    fuelConsumption: 8.0,
    fuelPrice: 8.5,
    unitText: '8.0L/100km，汽油 8.5元/L',
    formulaText: '总里程 / 100 * 8.0 * 8.5',
    getCost: (mileage) => (mileage / 100) * 8.0 * 8.5,
  },
  electric: {
    label: '新能源',
    electricConsumption: 17,
    electricPrice: 1,
    unitText: '17kWh/100km，公共充电 1元/kWh',
    formulaText: '总里程 / 100 * 17 * 1',
    getCost: (mileage) => (mileage / 100) * 17 * 1,
  },
  extended: {
    label: '增程',
    costPerKm: 0.48,
