...
export async function submitBudgetSnapshotToBackend(snapshot) {
  ...
  const payload = {
    ...
    energyType: snapshot.result?.energyType || snapshot.draft?.energyType || '',
    energySource: snapshot.result?.energySource || '',
    matchedVehicleName: snapshot.result?.matchedVehicleName || '',
